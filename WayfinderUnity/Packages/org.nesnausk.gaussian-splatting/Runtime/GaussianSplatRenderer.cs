...
namespace GaussianSplatting.Runtime
{
    class GaussianSplatRenderSystem
    {
        ...
        public bool GatherSplatsForCamera(Camera cam)
        {
            ...
            {
                var gs = kvp.Key;
                if (gs == null || !gs.isActiveAndEnabled || !gs.m_RenderEnabled ||
    ...
    public class GaussianSplatRenderer : MonoBehaviour
    {
        ...
        [Tooltip("Keep GPU resources warm while suppressing splat draw and sort work.")]
        public bool m_RenderEnabled = true;
